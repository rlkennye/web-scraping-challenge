...
def scrape_mars_image():
    ...
    try: 
        ...
        Mars_featured_image_url = main_url + Mars_featured_image_url

        # Display full link to featured image
        Mars_featured_image_url 

        # Dictionary entry from FEATURED IMAGE
        mars_info['Mars_featured_image_url'] = Mars_featured_image_url 
...
def scrape_mars_hemispheres():
    ...
    try: 
        ...
        mars_info['Mars_hemisphere_image_urls'] = Mars_hemisphere_image_urls
